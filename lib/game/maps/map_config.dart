...
class MapConfig {
  ...
  MapItem _map(String id) => MapItem(
      id: id,
      map: WorldMapByTiled(WorldMapReader.fromAsset('tiled/map-$id.json'), objectsBuilder: _objectsBuilder()));

  Map<String, ObjectBuilder> _objectsBuilder() => {
        'exitMap': (params) =>
            ExitMapSensor(params.position, params.size, MapArguments.fromMapSensorParams(params.others)),
